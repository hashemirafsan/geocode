...
pub fn capability_catalog() -> CapabilityCatalog {
    CapabilityCatalog {
        ...
        capabilities: vec![
            ...
            cap("netcdf.dimension.list", CapabilityKind::Core, "netcdf", "List dimensions in a NetCDF dataset.", "netcdf_dataset_handle", "dimension_list", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("netcdf_crate", "netcdf.dimension.list", 1, vec![], None), route("ncdump_binary", "ncdump.dimension.list", 2, vec![], None)]),
            ...
            cap("netcdf.variable.list", CapabilityKind::Core, "netcdf", "List variables in a NetCDF dataset.", "netcdf_dataset_handle", "netcdf_variable_ref_list", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("netcdf_crate", "netcdf.variable.list", 1, vec![], None), route("ncdump_binary", "ncdump.variable.list", 2, vec![], None)]),
            ...
            cap("stats.min", CapabilityKind::Core, "stats", "Compute the minimum value of an array.", "array_value", "scalar_value", CapabilityStatus::Implemented, CapabilityPriority::Next, true, vec![route("local_runtime", "stats.min", 1, vec![], None)]),
            cap("stats.max", CapabilityKind::Core, "stats", "Compute the maximum value of an array.", "array_value", "scalar_value", CapabilityStatus::Implemented, CapabilityPriority::Next, true, vec![route("local_runtime", "stats.max", 1, vec![], None)]),
