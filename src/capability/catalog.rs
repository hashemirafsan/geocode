...
pub fn capability_catalog() -> CapabilityCatalog {
    CapabilityCatalog {
        ...
        capabilities: vec![
            cap_with_planner_metadata("dataset.resolve", CapabilityKind::Core, "dataset", "Resolve a dataset alias or path into a dataset reference.", "dataset_selector", "dataset_ref", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("filesystem", "dataset.resolve", 1, vec![], None)], r#"{"path": "file.nc"} or {"alias": "dataset_name"}"#, None),
            ...
            cap_with_planner_metadata("dataset.open", CapabilityKind::Core, "dataset", "Open a dataset into a typed backend-specific handle.", "dataset_ref", "dataset_handle", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("netcdf_crate", "netcdf.dataset.open", 1, vec!["dataset:netcdf"], None), route("gdal_crate", "raster.dataset.open", 1, vec!["dataset:geotiff"], None)], r#"{"dataset": "$s1"}"#, Some("Consumes a dataset reference (from dataset.resolve) and returns a dataset handle for further operations.")),
            cap_with_planner_metadata("dataset.inspect", CapabilityKind::Composite, "dataset", "Inspect essential dataset metadata.", "dataset_ref", "metadata_value", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("netcdf_crate", "netcdf.dataset.inspect", 1, vec!["dataset:netcdf"], None), route("gdal_crate", "raster.dataset.inspect", 1, vec!["dataset:geotiff"], None), route("ncdump_binary", "ncdump.header.inspect", 2, vec!["dataset:netcdf"], None), route("gdalinfo_binary", "gdalinfo.metadata.inspect", 2, vec!["dataset:geotiff"], None)], r#"{"dataset": "$s1"}"#, None),
            ...
            cap_with_planner_metadata("netcdf.dimension.list", CapabilityKind::Core, "netcdf", "List dimensions in a NetCDF dataset.", "netcdf_dataset_handle", "dimension_list", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("netcdf_crate", "netcdf.dimension.list", 1, vec![], None), route("ncdump_binary", "ncdump.dimension.list", 2, vec![], None)], r#"{"dataset": "$s1"}"#, Some("Requires a dataset handle from dataset.open.")),
            ...
            cap_with_planner_metadata("netcdf.variable.list", CapabilityKind::Core, "netcdf", "List variables in a NetCDF dataset.", "netcdf_dataset_handle", "netcdf_variable_ref_list", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("netcdf_crate", "netcdf.variable.list", 1, vec![], None), route("ncdump_binary", "ncdump.variable.list", 2, vec![], None)], r#"{"dataset": "$s1"}"#, Some("Requires a dataset handle from dataset.open and returns a list of variable names. If you know the variable name already, skip this step and use netcdf.variable.load directly.")),
            cap_with_planner_metadata("netcdf.variable.describe", CapabilityKind::Core, "netcdf", "Describe a NetCDF variable including dtype, dimensions, and shape.", "netcdf_variable_ref", "variable_metadata", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("netcdf_crate", "netcdf.variable.describe", 1, vec![], None), route("ncdump_binary", "ncdump.variable.describe", 2, vec![], None)], r#"{"dataset": "$s1", "name": "variable_name"}"#, Some("Requires a dataset handle (not a variable list) plus a specific variable name. Do not pass the entire output of netcdf.variable.list; extract the variable name first.")),
            cap_with_planner_metadata("netcdf.variable.load", CapabilityKind::Core, "netcdf", "Load a NetCDF variable as a typed array value.", "netcdf_variable_selector", "array_value", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("netcdf_crate", "netcdf.variable.read_f64", 1, vec![], None), route("ncdump_binary", "ncdump.variable.read", 2, vec![], None)], r#"{"dataset": "$s1", "name": "variable_name"}"#, Some("Requires a dataset handle (not a variable list) plus a specific variable name. Do not pass the entire output of netcdf.variable.list; extract the variable name first.")),
            ...
            cap_with_planner_metadata("array.sort", CapabilityKind::Core, "array", "Sort an array in ascending or descending order.", "array_value", "array_value", CapabilityStatus::Implemented, CapabilityPriority::Next, true, vec![route("local_runtime", "array.sort", 1, vec![], None)], r#"{"input": "$s1", "descending": true}"#, Some("Use descending=true for top values and descending=false for bottom values.")),
            cap_with_planner_metadata("array.take", CapabilityKind::Core, "array", "Take the first N or last N values from an array.", "array_value", "array_value", CapabilityStatus::Implemented, CapabilityPriority::Next, true, vec![route("local_runtime", "array.take", 1, vec![], None)], r#"{"input": "$s1", "count": 5}" or {"input": "$s1", "count": 5, "from_end": true}"#, Some("Use from_end=true for last values. Combine with array.sort for top/bottom queries.")),
            ...
            cap_with_planner_metadata("stats.mean", CapabilityKind::Core, "stats", "Compute the arithmetic mean of an array or dataset target.", "stats_target", "scalar_value", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("local_runtime", "stats.mean", 1, vec![], None)], r#"{"input": "$s1"} or {"input": "$s1", "variable": "name"}"#, None),
            cap_with_planner_metadata("stats.min", CapabilityKind::Core, "stats", "Compute the minimum value of an array.", "array_value", "scalar_value", CapabilityStatus::Implemented, CapabilityPriority::Next, true, vec![route("local_runtime", "stats.min", 1, vec![], None)], r#"{"input": "$s1"} or {"input": "$s1", "variable": "name"}"#, None),
            cap_with_planner_metadata("stats.max", CapabilityKind::Core, "stats", "Compute the maximum value of an array.", "array_value", "scalar_value", CapabilityStatus::Implemented, CapabilityPriority::Next, true, vec![route("local_runtime", "stats.max", 1, vec![], None)], r#"{"input": "$s1"} or {"input": "$s1", "variable": "name"}"#, None),
            ...
            cap_with_planner_metadata("compare.mean_delta", CapabilityKind::Composite, "compare", "Compute mean_b - mean_a between two compatible dataset targets.", "dataset_ref_pair", "table_value", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("local_runtime", "compare.mean_delta", 1, vec![], None)], r#"{"left": "$s1", "right": "$s2"} or add "variable": "name""#, None),
            ...
            cap_with_planner_metadata("render.scalar", CapabilityKind::Composite, "render", "Render a scalar result for output.", "scalar_like_value", "scalar_value", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("local_runtime", "render.scalar", 1, vec![], None)], r#"{"input": "$s1", "label": "Result label"}"#, None),
            cap_with_planner_metadata("render.table", CapabilityKind::Composite, "render", "Render a table result for output.", "table_like_value", "table_value", CapabilityStatus::Implemented, CapabilityPriority::Mvp, true, vec![route("local_runtime", "render.table", 1, vec![], None)], r#"{"inputs": ["$s1", "$s2"], "title": "Results"}"#, Some("For multiple scalar outputs (like min and max), use a single render.table with an inputs array rather than multiple render.scalar steps.")),
